...
###################### THIS IS FROM HACKTRICKS. WORKS ASWELL
import angr
import sys
...
###################### THIS IS WHAT I ACTUALLY USED TO GET THE VALUE
# #!/usr/bin/python3

# import angr

# file_to_load = "./hashpretence"

# project = angr.Project(file_to_load)
# state = project.factory.entry_state()
# simmgr = project.factory.simulation_manager(state)
# simmgr.explore(find=lambda state: b"SUCCESS" in state.posix.dumps(1))
# if simmgr.found:
